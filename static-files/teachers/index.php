...
<?php include_once("../include/module/header.php")?>
	...
	<div class="instructions">
		...
		<p>Make sure you have everything set up beforehand to give the students plenty of time to play with the tools.</p>
		...
		<h3>Introduction:</h3>
		<h4>What is hacking? What is the open web? What is web-making? (5-10 mins)</h4>
		...
		<h4>How to look under the bonnet of a website and live-edit the contents of any web page. (20 mins)</h4>
