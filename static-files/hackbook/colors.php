...
<body class="page-colors" onload="prettyPrint()">
...
<article class="snippet" id="color-words">
	...
	<ul class="colors">
		<li><span style="background-color:Orange">Orange</span>
			<ul>
				<li style="background-color:LightSalmon">LightSalmon</li>
	...
	<ul class="colors">
		<li><span style="background-color:Yellow">Yellow</span>
			<ul>
				<li style="background-color:Gold">Gold</li>
				<li style="background-color:LightYellow">LightYellow</li>
				<li style="background-color:LemonChiffon">LemonChiffon</li>
				<li style="background-color:LightGoldenrodYellow">LightGoldenrodYellow</li>
				...
				<li style="background-color:Khaki">Khaki</li>
	...
	<ul class="colors">
		<li><span style="background-color:Blue; color:white; text-shadow:-1px -1px 0 rgba(0,0,0,0.4)">Blue</span>
			<ul>
				...
				<li style="background-color:Aquamarine">Aquamarine</li>
				...
				<li style="background-color:CadetBlue">CadetBlue</li>
				...
				<li style="background-color:CornflowerBlue">CornflowerBlue </li>
	...
	<ul class="colors">
		<li><span style="background-color:Pink">Pink</span>
			<ul>
	...
	<ul class="colors">
		<li><span style="background-color:White">White</span>
			<ul>
				<li style="background-color:Snow">Snow</li>
				<li style="background-color:Honeydew">Honeydew </li>
				<li style="background-color:MintCream">MintCream </li>
				<li style="background-color:Azure">Azure</li>
				<li style="background-color:AliceBlue">AliceBlue </li>
				<li style="background-color:GhostWhite">GhostWhite </li>
				<li style="background-color:WhiteSmoke">WhiteSmoke </li>
				<li style="background-color:Seashell">Seashell </li>
				<li style="background-color:Beige">Beige</li>
				<li style="background-color:OldLace">OldLace </li>
				<li style="background-color:FloralWhite">FloralWhite </li>
				<li style="background-color:Ivory">Ivory</li>
				<li style="background-color:AntiqueWhite">AntiqueWhite</li>
				<li style="background-color:Linen">Linen</li>
				<li style="background-color:LavenderBlush">LavenderBlush</li>
...
<!--<article class="snippet" id="color-hes">
	...
	<ul class="colors">
		<li><span style="background-color:Red">#FF0000</span>
			<ul>
				<li style="background-color:IndianRed">#CD5C5C</li>
				<li style="background-color:LightCoral">LightCoral</li>
				<li style="background-color:Salmon">Salmon</li>
				<li style="background-color:DarkSalmon">DarkSalmon</li>
				<li style="background-color:LightSalmon">LightSalmon</li>
	...
	<ul class="colors">
		<li><span style="background-color:Orange">#FFA500</span>
			<ul>
				<li style="background-color:LightSalmon">LightSalmon</li>
				<li style="background-color:Coral">Coral</li> 	 	
				<li style="background-color:Tomato">Tomato</li>
	...
	<ul class="colors">
		<li><span style="background-color:Yellow">#FFFF00</span>
			<ul>
				<li style="background-color:Gold">Gold</li>
				<li style="background-color:LightYellow">LightYellow</li>
				<li style="background-color:LemonChiffon">LemonChiffon</li>
	...
	<ul class="colors">
		<li><span style="background-color:Green">#008000</span>
			<ul>
				<li style="background-color:GreenYellow">GreenYellow </li>
				<li style="background-color:Chartreuse">Chartreuse</li>
				<li style="background-color:LawnGreen">LawnGreen</li>
	...
	<ul class="colors">
		<li><span style="background-color:Blue">#0000FF</span>
			<ul>
				<li style="background-color:Aqua">Aqua </li>
				<li style="background-color:Cyan">Cyan </li>
				<li style="background-color:LightCyan">LightCyan</li>
	...
	<ul class="colors">
		<li><span style="background-color:Pink">#FFC0CB</span>
			<ul>
				<li style="background-color:LightPink">LightPink</li>
				<li style="background-color:HotPink">HotPink</li>
	...
	<ul class="colors">
		<li><span style="background-color:Purple">#800080</span>
			<ul>
				<li style="background-color:Lavender">Lavender</li>
				<li style="background-color:Thistle">Thistle</li>
				<li style="background-color:Plum">Plum</li>
	...
	<ul class="colors">
		<li><span style="background-color:Brown">#A52A2A</span>
			<ul>
				<li style="background-color:Cornsilk">Cornsilk</li>
				<li style="background-color:BlanchedAlmond">BlanchedAlmond</li>
				<li style="background-color:Bisque">Bisque</li>
	...
	<ul class="colors">
		<li><span style="background-color:White">#FFFFFF</span>
			<ul>
				<li style="background-color:Snow">Snow</li>
				<li style="background-color:Honeydew">Honeydew </li>
				<li style="background-color:MintCream">MintCream </li>
	...
	<ul class="colors">
		<li><span style="background-color:Gray">#808080</span>
			<ul>
				<li style="background-color:Gainsboro">Gainsboro</li>
				<li style="background-color:LightGrey">LightGrey</li>
				<li style="background-color:Silver">Silver</li>
...
<article class="snippet" id="color-rgba">
<h1>RGBA colors</h1>

	<ul class="colors">
		<li><span style="background-color:Red">rgba(255,0,0,1)</span>
			<ul>
	...
	<ul class="colors">
		<li><span style="background-color:Orange">rgba(255,165,0,1)</span>
			<ul>
				<li style="background-color:LightSalmon">LightSalmon</li>
				<li style="background-color:Coral">Coral</li> 	 	
				<li style="background-color:Tomato">Tomato</li>
	...
	<ul class="colors">
		<li><span style="background-color:Yellow">rgba(255,255,0,1)</span>
			<ul>
				<li style="background-color:Gold">Gold</li>
				<li style="background-color:LightYellow">LightYellow</li>
				<li style="background-color:LemonChiffon">LemonChiffon</li>
	...
	<ul class="colors">
		<li><span style="background-color:Green">rgba(0,128,0,1)</span>
			<ul>
				<li style="background-color:GreenYellow">GreenYellow </li>
				<li style="background-color:Chartreuse">Chartreuse</li>
				<li style="background-color:LawnGreen">LawnGreen</li>
	...
	<ul class="colors">
		<li><span style="background-color:Blue">rgba(0,0,255,1)</span>
			<ul>
				<li style="background-color:Aqua">Aqua </li>
				<li style="background-color:Cyan">Cyan </li>
				<li style="background-color:LightCyan">LightCyan</li>
	...
	<ul class="colors">
		<li><span style="background-color:Pink">rgba(255,192,203,1)</span>
			<ul>
				<li style="background-color:LightPink">LightPink</li>
				<li style="background-color:HotPink">HotPink</li>
				<li style="background-color:DeepPink">DeepPink</li>
	...
	<ul class="colors">
		<li><span style="background-color:Purple">rgba(128,0,128,1)</span>
			<ul>
				<li style="background-color:Lavender">Lavender</li>
				<li style="background-color:Thistle">Thistle</li>
				<li style="background-color:Plum">Plum</li>
	...
	<ul class="colors">
		<li><span style="background-color:Brown">rgba(165,42,42,1)</span>
			<ul>
				<li style="background-color:Cornsilk">Cornsilk</li>
				<li style="background-color:BlanchedAlmond">BlanchedAlmond</li>
				<li style="background-color:Bisque">Bisque</li>
	...
	<ul class="colors">
		<li><span style="background-color:White">rgba(255,255,255,1)</span>
			<ul>
				<li style="background-color:Snow">Snow</li>
				<li style="background-color:Honeydew">Honeydew </li>
				<li style="background-color:MintCream">MintCream </li>
	...
	<ul class="colors">
		<li><span style="background-color:Gray">rgba(128,128,128,1)</span>
			<ul>
				<li style="background-color:Gainsboro">Gainsboro</li>
				<li style="background-color:LightGrey">LightGrey</li>
				<li style="background-color:Silver">Silver</li>
